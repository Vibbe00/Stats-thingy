...
export const MatchEntry = ({ match, region, gameName, tagLine }) => {
  ...
  return (
    <div className={`match-entry ${match.player.win ? "victory" : "defeat"}`}>
      ...
      <div className="match-header">
        <span className={`game-mode ${match.player.win ? "victory" : "defeat"}`}>
      ...
      <div className="items-and-stats">
        <div className="items">
          {match.player.items.map((item, index) =>
            item.icon
              ? <img key={index} className="item-icon" src={item.icon} alt={item.id} />
          ...
          <div className="blue-team">
            {details.teams.blue.map((player, i) => (
              <div key={i} className="player-entry">
                <img className="player-champion-icon" src={player.championIcon} alt={player.championName} />
